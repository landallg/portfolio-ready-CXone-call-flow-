...
Contact Center Architecture — inbound PSTN routing, DNIS mapping, business hours logic, ACD skill transfers, and tier‑based support routing

Cloud‑Aligned Design — applied AWS‑style logging and monitoring patterns to support observability and troubleshooting

IVR/ACD Logic — menu routing, after‑hours handling, exception paths, and callback flow design
